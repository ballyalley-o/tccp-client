...
const BootcampFeedbackRatingStack = ({ rating, setRating }: { rating: number | null, setRating: React.Dispatch<React.SetStateAction<number | null>> }) => {
    return (
...
const BootcampFeedbackFormCard = ({ title, setTitle, body, setBody, handleSubmit, rating, setRating, canSubmit, createStatus }: BootcampFeedbackFormCardProps) => {
  return (
    <Card>
      <CardContent>
